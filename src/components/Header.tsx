      ...
      <div className="px-3 py-2">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <h1 className="text-sm font-bold text-slate-800">포토스팟</h1>
          </div>
          ...
          <nav className="flex items-center space-x-1">
            ...
            <button 
              ...
              className="flex items-center space-x-1 px-2 py-1 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-xs font-medium"
            >
